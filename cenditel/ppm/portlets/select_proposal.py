...
class IProjectProposalsDashboardPortlet(IPortletDataProvider):
    pass

class Assignment(base.Assignment):
    implements(IProjectProposalsDashboardPortlet)
...
class Renderer(base.Renderer):
    render = ViewPageTemplateFile('select_proposal.pt')
...
class AddForm(base.NullAddForm):
    form_fields = form.Fields(IProjectProposalsDashboardPortlet)
    label = _(u"Add Project Proposals Portlet")
    description = _(u"This portlet displays a form for select some criteria and find quickly project proposal registered based on those criteria.")
...
#    form_fields = form.Fields(IProjectProposalsDashboardPortlet)
#    label = _(u"Edit Project Proposals Portlet")
#    description = _(u"This portlet displays a form for select some criteria and find quickly project proposal registered based on those criteria.")
